...
I am an economist with research interests in economic history and macroeconomics. In 2024-25, I was a pre-doc at the Department of Economics and [the Centre for Economics, Policy and History](https://ceph.ie/people-re/kirill-kushnarev/) at Trinity College Dublin, working with [Dr. Marvin Suesse](https://marvinsuesse.com).
...
I publish data, coding, and applied econometrics, including new Stata packages and linkage algorithms, [here](people.qmd). Also, I run a pro-bono course on Russian Economic History for graduate students and anyone interested. The syllabus and lectures can be found [here](teaching.qmd), with the next enrollment in Fall 2026.

You can find my CV [here](posts.qmd#category=paper). My email is [kkushnarev@alumni.lse.ac.uk](mailto:kkushnarev@alumni.lse.ac.uk).
