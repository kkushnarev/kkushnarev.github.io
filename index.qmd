...
I publish data, coding, and applied econometrics, including new Stata packages and linkage algorithms, [here](posts.qmd#category=presentation). Also, I run a pro-bono course on Russian Economic History for graduate students and anyone interested. The syllabus and lectures can be found [here](teaching.qmd), with the next enrollment in Fall 2025.
